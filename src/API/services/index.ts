...
export { createPartenaireExterneService, getPartenaireStatisticsService, getPartenairesExternesService, updatePartenaireExterneService } from './partenaireExterne.service.ts';
...
export {
  ...
  getSocialPublicationDetailService,
