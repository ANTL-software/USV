...
import { IoArrowBack, IoTime, IoStatsChart, IoCalendar, IoDocumentText, IoCloudUpload, IoClose } from 'react-icons/io5';
...
const ACTIONS: ActionItem[] = [
  ...
  { id: 5, label: 'Export données', icon: <MdDownload />, description: 'Exporter les données de l\'employé' },
];
