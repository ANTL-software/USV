...
function CampagneForm(): ReactElement {
  ...
  const {
    ...
    handleChange, handleModesPaiementChange, handleSubmit, paymentOptions,
              ...
              <fieldset>
                ...
                <fieldset className="campagneForm__fieldset">
                  ...
                  <div className="campagneForm__modes-description">
                    Utilisez cette section si la facture ou le bon de commande doit être émis au nom d’un tiers distinct de la campagne.
                  </div>
                  ...
                  <div className="campagneForm__doc-grid">
                    <label>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Ex: SAS BM DEVELOPPEMENT"
                      />
                    </label>
                    ...
                    <label>
                      ...
                      <input
                        type="text"
                        name="invoice_siret"
                        value={form.invoice_siret}
                        onChange={handleChange}
                        placeholder="44343310700000"
                        maxLength={14}
                      />
                    </label>
                    ...
                    <label className="campagneForm__label-full">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={2}
                        placeholder="Adresse du tiers facturé..."
                      />
                    </label>
                ...
                <fieldset className="campagneForm__fieldset">
                  ...
                  <Select
                    isMulti
                    value={paymentOptions.filter((opt) => form.modes_paiement.split(',').includes(opt.value))}
