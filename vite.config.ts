...
const generateCSP = () => {
  return {
    ...
    buildStart() {
      ...
      const prodCSP = "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob:; style-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com https://fonts.googleapis.com; img-src 'self' data: blob: https://api.antl.fr; connect-src 'self' https://api.antl.fr https://fonts.googleapis.com https://unpkg.com https://eventgw.twilio.com https://media.twiliocdn.com https://sdk.twilio.com wss://voice-js.roaming.twilio.com; frame-src 'self' https://api.antl.fr blob:; object-src 'self' blob:; worker-src 'self' blob:; media-src 'self' mediastream: https://media.twiliocdn.com https://sdk.twilio.com; base-uri 'self'; form-action 'self'; frame-ancestors 'none'; upgrade-insecure-requests;";
